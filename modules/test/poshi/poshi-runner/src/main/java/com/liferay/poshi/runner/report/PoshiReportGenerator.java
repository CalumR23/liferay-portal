...
public class PoshiReportGenerator {
	...
	public static void main(String[] args) throws Exception {
		...
		else if (_poshiProperties.reportType.equals("methodProperties")) {
			_writeTestCaseMethodNamesProperties();
		}
		else if (_poshiProperties.reportType.equals("generatedProperties")) {
	...
	private static void _writeTestGeneratedProperties() throws Exception {
		...
		for (String testCaseNamespacedClassCommandName :
				PoshiContext.getTestCaseNamespacedClassCommandNamesNames()) {
